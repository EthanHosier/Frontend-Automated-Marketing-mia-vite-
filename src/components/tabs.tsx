...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center bg-white p-1 text-muted-foreground rounded-full",
      className
    )}
    {...props}
  />
