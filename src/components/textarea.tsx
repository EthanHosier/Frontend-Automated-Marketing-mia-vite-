      ...
      >
        <div className="group relative z-0 mb-0 w-full flex pt-4 px-4">
          <textarea
            ...
            className="peer block w-full resize-none appearance-none bg-transparent px-0  text-grayscaleText-body focus:border-blue-600 focus:outline-none focus:ring-0 mt-1 overflow-hidden max-h-[200px] !text-base"
            placeholder=" "
